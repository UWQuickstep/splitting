...
class TotalSizeAggregate
 ...
 public:
  explicit TotalSizeAggregate(TypePtr resultType)
...
bool registerTotalSize(const std::string& name) {
  ...
  return exec::registerAggregateFunction(
      ...
      [name](
        ...
        return std::make_unique<TotalSizeAggregate>(resultType);
      });
}

} // namespace

void registerTotalSizeAggregate(const std::string& prefix) {
  registerTotalSize(prefix + kTotalSize);
}
